...
class OldPhotosAssymetricModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_feature', type=float, default=10, help='weight for Feature matching loss')
            parser.add_argument('--discriminator_frequency', type=int, default=3, help='at which iterations is discriminator trained')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_L1', 'D_real', 'D_fake', 'D_feature']
    ...
    def backward_G(self):
        ...
        # combine loss and calculate gradients
        self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_D_feature
        self.loss_G.backward()

    def optimize_parameters(self):
        self.forward()                   # compute fake images: G(A)
        # update D every 3rd time
        if self.iteration % self.opt.discriminator_frequency == 0:
